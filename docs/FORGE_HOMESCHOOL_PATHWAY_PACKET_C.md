...
| --- | --- | --- |
| `catalog.ts` | S0 read-only projection | Maps released World manifests to current capability IDs, reviewed entitlement areas, age-specific source policies, tiers, sources, and existing event types. |
