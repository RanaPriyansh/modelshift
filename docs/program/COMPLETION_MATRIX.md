...
| G2 Learning Kernel and World factory | `PARTIAL`; four-World shared runtime, exact compiler, and pure curriculum graph accepted | W5-C SQL remains in re-review; the fifth retained package remains rejected pending domain/content/public-boundary repair; every future World still requires independent runtime/source/curriculum/content/access acceptance before public release. |
