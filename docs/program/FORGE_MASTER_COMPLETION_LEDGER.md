...
Status: **Canonical Semester Desk v2 implementation is running**
...
- A canonical `/app` Semester Desk v2 implementation is in progress.
- The Semester Desk route is a development fixture and renders an unavailable production shell.
- A strict profile-bound local persistence adapter is in progress.
...
|---|---|---|---|
| Account and onboarding | Implementation running | Partial local flow | Clear profile boundary and safe local adapter |
| Add or import courses | Manual-input implementation running | Starter course only | Supported manual method with honest source state |
| Review facts, freshness, conflicts | Domain complete; UI running | New domain implementation running | Human terms and explicit student choice |
| Whole-semester view | Domain complete; UI running | New domain implementation running | No hidden prioritisation |
| Declare real capacity | Domain complete; UI running | New domain implementation running | Student controls available capacity |
| Recover a broken week | Domain complete; UI running | New domain implementation running | Transparent changes with no shame |
| Choose the next action | Domain complete; UI running | New domain implementation running | One honest action with visible reason |
| Protected study | Domain complete; UI running | Starter flow exists; v2 domain running | Active learning before help |
| Practice | Domain complete; UI running | Starter flow exists; v2 domain running | Deterministic check and no answer extraction |
| Independent proof | Domain complete; UI running | Starter flow exists; v2 domain running | Proof after help |
| Delayed return | Domain complete; UI running | Starter flow exists; v2 domain running | Schedule, remind, reopen, and complete |
...
| Offline and interruption | Not verified | Partial | Recover without silent loss |
...
| P1 | Model-driven activity dismissal can bypass draft confirmation and lose the local draft. | Repair running |
...
3. iOS activity dismissal repair and runtime proof are not complete.
...
| Item | Current state |
|---|---|
| Simulator build | Available, but final evidence is missing |
...
1. Review and integrate the canonical `/app` implementation.
2. Finish the iOS activity-draft repair and run its simulator tests.
3. Review the native Semester Desk v2 domain.
4. Establish clean web and iOS checkpoints.
5. Implement the remaining native Semester Desk v2 application loop.
