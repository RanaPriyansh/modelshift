...
async function readBoundedBody(request: Request): Promise<string | null> {
  ...
  if (Number.isFinite(declaredLength) && declaredLength > MAX_INTERPRET_REQUEST_BYTES) {
    return null;
  }
...
export function createInterpretPost(
  dependencies: InterpretRouteDependencies = DEFAULT_DEPENDENCIES,
) {
