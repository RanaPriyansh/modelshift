...
export const metadata: Metadata = {
  title: "ModelShift focus session — FORGE",
  description: "The exact ModelShift protocol bound to one device-local path session.",
};
...
export default async function ModelShiftFocusSessionPage({
  params,
}: {
  ...
  return (
    <ForgeWorldFrame exitHref="/app/study" worldLabel="ModelShift focus session">
      <StudySessionRuntime
