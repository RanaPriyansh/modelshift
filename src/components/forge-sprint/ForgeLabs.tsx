    ...
    <ProductShell active="labs">
      <main className="forge-labs" id="forge-sprint-main" tabIndex={-1}>
        <header className="forge-page-heading">
          ...
          <p>
            Labs connect the Project Sprint to FORGE Learning OS: short, bounded paths for
        ...
        <aside className="forge-labs-note">
          <strong>The project stays primary.</strong>
          <p>FORGE will not interrupt your build with a mandatory course or mode shift. Use a reviewed World when it earns its place.</p>
