...
const emittedReceipt = { attemptId: "attempt.route-receipt" } as BoundedLocalWorldRuntimeReceipt;
...
vi.mock("@/src/components/worlds/proportional-reasoning", () => ({
  ProportionalReasoningWorld: (props: { onRuntimeReceipt?: (receipt: BoundedLocalWorldRuntimeReceipt) => void; onEvidence?: unknown }) => {
    ...
    return <button type="button" onClick={() => props.onRuntimeReceipt?.(emittedReceipt)}>emit receipt</button>;
  },
}));
