  ...
  return (
    <section className="forge-section forge-worlds" id="worlds" aria-labelledby="worlds-title">
      <ForgeSectionHeading
        ...
        description="Three Worlds work end to end across simulation, exact mathematics, and source reasoning. The rest name the intended breadth without pretending the curriculum already exists."
      />
