...
const SEMANTICS = deepFreeze([
  {
    ...
    controlLabel: "Inspect the local study boundary",
    controlEffect: "navigate_to_local_synthetic_detail",
    navigationOnly: true,
  ...
  },
  {
    ...
    controlKind: "local_anchor_navigation",
    controlLabel: "Inspect the local source boundary",
    controlEffect: "navigate_to_local_synthetic_detail",
    navigationOnly: true,
  ...
  },
  {
    ...
    nextJobOwner: "learner_fixture",
    controlKind: "local_anchor_navigation",
    controlLabel: "Inspect the local recovery boundary",
    controlEffect: "navigate_to_local_synthetic_detail",
    navigationOnly: true,
    stopOwner: "learner_fixture",
    dependencyCount: 2,
...
export const UNIVERSITY_RESEARCH_RENDERER_BINDING_DESCRIPTOR = deepFreeze({
  ...
  primaryControl: {
    nodeKind: "next_job",
    labelSource: "scenario.nextJob.primaryControl.label",
    effectSource: "scenario.nextJob.primaryControl.effect",
    navigationTargetStrategy:
      "same_scenario_effect_boundary_fragment",
    noControlPresentation: "plain_boundary_text",
  },
  copybook: {
    enumPresentation: "ascii_lowercase_underscore_to_spaces_v1",
    booleanPresentation: "yes_no_v1",
    timestampPresentation: "exact_utc_iso_8601_v1",
    identifierPresentation: "exact_bdi_code_v1",
  },
...
export const UNIVERSITY_RESEARCH_NEUTRAL_SUBSTITUTE_DECLARATION = deepFreeze({
  ...
  surface: {
    ...
    nodes: [
      ...
      {
        kind: "next_job",
        nodeRef: "worksheet.next-job",
        heading: "Current bounded job",
        source: "scenario.nextJob",
      },
      {
  ...
  density: {
    maximumVisibleCharactersPerScenario: 2_400,
    maximumFactRows: 8,
    maximumChoices: 3,
  },
