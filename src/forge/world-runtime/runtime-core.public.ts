...
function receiptFor<State, DomainEvent, DomainProof>(
  ...
  session: WorldRuntimeSession<State, DomainProof>,
  proof: DomainProof,
  authority: WorldRuntimeAuthority,
): ReceiptCreation {
  ...
  if (!canonicalRegistration) throw new WorldRuntimeConfigurationError(
    "unknown_canonical_validator",
...
function createWorldRuntimeSessionWithAuthority<State, DomainEvent, DomainProof>(
  adapter: WorldRuntimeAdapter<State, DomainEvent, DomainProof>,
  authority: WorldRuntimeAuthority,
...
function dispatchWorldRuntimeCommandWithAuthority<State, DomainEvent, DomainProof>(
  adapter: WorldRuntimeAdapter<State, DomainEvent, DomainProof>,
  authority: WorldRuntimeAuthority,
  session: WorldRuntimeSession<State, DomainProof>,
